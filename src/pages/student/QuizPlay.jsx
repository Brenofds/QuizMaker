...
// Tela de jogo do aluno: uma pergunta por vez, feedback colorido, placar final.
...
function ScoreScreen({ score, total, quizTitle, onRestart, onHome }) {
  ...
  return (
    <div style={{
      ...
      <div className="card animate-fade-up" style={{ maxWidth: 460, width: '100%', padding: 40, textAlign: 'center' }}>
        ...
        {/* Score */}
        <div style={{
          fontSize: 64, fontFamily: 'var(--font-display)', fontWeight: 800,
          color: barColor, lineHeight: 1, marginBottom: 4,
        }}>
        ...
        <p style={{ fontSize: 15, fontWeight: 600, color: 'var(--navy)', marginBottom: 32 }}>
          {message}
        </p>
...
export default function QuizPlay() {
  ...
  const [selected, setSelected] = useState(null);   // optionId chosen by student
  ...
  const optionStyle = (opt) => {
    ...
    return {
      ...
      fontSize: 15, fontWeight: answered && isCorrectOpt ? 600 : 400,
    ...
    <div style={{
      ...
      <div className="card animate-fade-up" style={{ width: '100%', maxWidth: 640, padding: 32 }}>
        ...
        <h2 style={{
          ...
          color: 'var(--navy)', marginBottom: 24, lineHeight: 1.4,
        }}>
          {q.text}
        </h2>
        ...
        {answered && q.explanation && (
          <div className="animate-fade-in" style={{
            ...
            fontSize: 13, color: 'var(--amber-dark)',
